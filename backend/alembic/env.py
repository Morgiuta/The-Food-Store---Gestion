"""Alembic environment configuration for Food Store (async)."""
...
from backend.auth.models import Usuario, Rol, UsuarioRol, RefreshToken, DireccionEntrega
...
from backend.pedidos.models import EstadoPedido, Pedido, DetallePedido, HistorialEstadoPedido
...
def run_migrations_online() -> None:
    """Run migrations online using async."""
